...
import batch.UpdateOrderStatus;

public class UpdateOrderStsListener implements ServletContextListener {
	private Timer iTimer = null;

	private UpdateOrderStatus myTask = null;
