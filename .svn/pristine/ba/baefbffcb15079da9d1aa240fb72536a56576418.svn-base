...
<body onload="init();">
    <s:form name="form1" theme="simple" enctype="multipart/form-data">
        ...
        <div id="div1">
        <h3>STEP1:生成发货单（一个为123mart一个为3eshop，顺序无所谓）</h3>
        ...
        <tr>
            <td><input type="button" value="生成" onclick="popupDiv();actionSubmit('A06020102')"></td>
        </tr>
        </table>
		</div>
	<br><br><br><br><br><br>
	...
	<br><br><br><br>
        <div id="div1">
        <h3>STEP2:批量扣除库存（一个为123mart一个为3eshop，顺序无所谓）</h3>
        <table>
        <tr>
            <td><input type="file" name="inputPath2" /></td>
            <td><input type="file" name="inputPath4" /></td>
        </tr>
        <tr>
            <td><input type="button" value="生成" onclick="popupDiv();actionSubmit('A06020103');"></td>
        </tr>
        </table>
        </div>
