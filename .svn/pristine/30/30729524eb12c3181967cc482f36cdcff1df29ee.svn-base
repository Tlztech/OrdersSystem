...
public class A10010215Action extends BaseAction {
	...
	protected void exec() throws Exception {
		...
		String toiawasebango = f100102.getToiawasebango_tuikahaso();
		String haisokaisha = f100102.getHaisohoho_tuikahaso();
		String haisohoho = f100102.getHaisokaisha_tuikahaso();

		List<String> messageList = orderCommon.tuikahaso(shoribango,
				toiawasebango, haisohoho, haisokaisha);
