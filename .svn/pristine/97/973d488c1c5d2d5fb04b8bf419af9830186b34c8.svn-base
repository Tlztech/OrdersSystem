...
public class A10010217Action extends BaseAction {
	...
	protected void exec() throws Exception {
		...
		String henkinkakaku = f100102.getHenkinkinkaku();
		String biko = f100102.getHenkinbiko();
		String shoribango = f100102.getShoribango_henkin();

		List<String> messageList = orderCommon.updateHenkin(shoribango,
				henkinkakaku, biko);
