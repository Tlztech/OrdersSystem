...
public class A10010304Action extends BaseAction {
	...
	protected void exec() throws Exception {
		String shohinbango = f100103.getTuikashohinbango();
		f100103.setTuikashohinbango("");
	...
	protected void isValidated() throws Exception {
		String shohinbango = Utility.strTrim(f100103.getTuikashohinbango());
		f100103.setTuikashohinbango(shohinbango);
