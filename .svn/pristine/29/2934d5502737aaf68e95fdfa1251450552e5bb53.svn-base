...
<!--                 <td class="td_bg"> -->
<%--                     <s:select list="#{ '銀行振込':'銀行振込','代金引換':'代金引換','クレジットカード':'クレジットカード','楽天バンク決済':'楽天バンク決済','Edy決済':'Edy決済'}" name="f100103.oshiharaihoho" /> --%>
<!--                 </td> -->
<!--             </tr> -->
<!-- 		    <tr class="bg_tr"> -->
...
<%--                 <td class="td_bg" align="right" colspan="4"><s:label name="f100103.pointriyo"/><s:hidden name="f100103.pointriyo"/>円</td> --%>
<!--             </tr> -->
<!--             <tr> -->
...
<s:textarea style="width:1000px;height:670px" name="testReslut"/>
	</s:form>
</body>
<script type="text/javascript">
