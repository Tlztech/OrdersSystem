...
public class OrderList implements Serializable {
	...
	private List<String> shohinbangoList = null;
	private String red_flg = null;
	...
	/**
	 * @return the otodokeshiteibi
	 */
	public String getOtodokeshiteibi() {
		return otodokeshiteibi;
	}

	/**
	 * @param otodokeshiteibi
	 *            the otodokeshiteibi to set
	 */
	public void setOtodokeshiteibi(String otodokeshiteibi) {
		this.otodokeshiteibi = otodokeshiteibi;
	}
	...
	public List<String> getShohinbangoList() {
		return shohinbangoList;
	}

	public void setShohinbangoList(List<String> shohinbangoList) {
		this.shohinbangoList = shohinbangoList;
	}
	...
	public void setRed_flg(String red_flg) {
