...
public class Supersale {
	...
	public void basicUpdate(String shop) throws Exception {
		...
		String[] List10 = new String[] { "fsf15", "nzck095", "nzctx354", "nzctx638", "nzctx745", "nzctx763", "nzctx786",
				"nzctx787", "nzddk250", "nzlyq1452", "nzlyq1504", "nzlyq1505", "nzlyq1506", "nzlyq1508", "nzlyq1514",
				"nzlyq1516", "nzxdk053", "nzxdk059", "nzxdk066", "xbx043", "xbx057", "xbx105" };
		...
		File file = new File("D:\\pages\\supersale_pc.html");
		...
		try {
			File f = new File("D:\\temp\\supersale_pc" + shop + ".html");
			if (!f.exists()) {
				f.createNewFile();
			}
	...
	private String getAxml() {
		String a_xml = "";
		a_xml += "<table align=\"center\" cellspacing=\"1\" cellpadding=\"0\"  width=\"700px\">\n";
		a_xml += "    <tr>\n";
