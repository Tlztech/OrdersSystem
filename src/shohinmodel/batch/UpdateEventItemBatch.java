...
public class UpdateEventItemBatch extends TimerTask {
	/**
	 * 　ReceiveEmail类测试
	 */
...
//			if (4 == hour || 2 == hour || 3 == hour) {
//				EventCommon common = new EventCommon();
//				List<String> shohinbangoList_temp = common
//						.getNoSaleShohinList(30);
...
//					}
//				}
//				// List<String> todayListTrend =
//				// common.getTodayList("trend777");
//				List<String> todayListCover = common
//						.getTodayList("coverforefront");
//				// List<String> tommorowListTrend =
//				// common.getTommorowList("trend777");
...
//						try {
//							common.updateEventItem("coverforefront",
//									shohinbango, 0, "", "");
//						} catch (NullPointerException e) {
//							continue;
//						}
...
//				// common.addEventItemToDB(itemListTrendToday, startDay1,
//				// "trend777");
...
//						try {
//							common.updateEventItem("coverforefront",
//									item.getItemUrl(), 1, startDataTimeToday,
//									endDataTimeToday);
//							shoribangoList.add(item.getItemUrl());
//						} catch (NullPointerException e) {
//							continue;
...
//							common.updateEventItem("coverforefront",
//									item.getItemUrl(), 1,
//									startDataTimeTommorrow,
//									endDataTimeTommorrow);
//							shoribangoList.add(item.getItemUrl());
//						} catch (NullPointerException e) {
//							continue;
//						}
