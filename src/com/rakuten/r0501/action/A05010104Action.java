...
public class A05010104Action extends BaseAction {
	...
	protected void exec() throws Exception {
		List<CommodityList> commodityLists = f050101.getCommodityList();
		for (int i = 0; i < commodityLists.size(); i++) {

			if ("false".equals(commodityLists.get(i).getCheckFlg())) {
				continue;
			}
			CommodityList commodity = f050101.getCommodityList().get(i);
