...
public class OtherCsvBean implements Serializable {
	...
	private String soufusakijusho3 = null;
	...
	List<OtherDetailCsvBean> shousaiList = null;

	public List<OtherDetailCsvBean> getShousaiList() {
		return shousaiList;
	}

	public void setShousaiList(List<OtherDetailCsvBean> shousaiList) {
	...
	public void setSoufusakimeijinamaefurigana(String soufusakimeijinamaefurigana) {
	...
	public String getSoufusakijusho3() {
		return soufusakijusho3;
	}

	public void setSoufusakijusho3(String soufusakijusho3) {
		this.soufusakijusho3 = soufusakijusho3;
	}
