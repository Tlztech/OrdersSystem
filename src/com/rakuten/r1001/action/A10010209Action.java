...
public class A10010209Action extends BaseAction {
	...
	protected void exec() throws Exception {
		...
		shoribango = f100102.getShoribango_henpinhaso();
		String toiawasebango = f100102.getToiawasebango_henpinhaso();
		String haisokaisha = f100102.getHaisokaisha_henpinhaso();
		String haisohoho = f100102.getHaisohoho_henpinhaso();

		List<String> messageList = orderCommon.henpinhaso(shoribango,
				toiawasebango, haisokaisha, haisohoho);
