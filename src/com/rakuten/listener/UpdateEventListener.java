...
import shohinmodel.batch.UpdateEventItemBatch;

public class UpdateEventListener implements ServletContextListener {
	private Timer iTimer = null;

	private UpdateEventItemBatch myTask = null;
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		myTask = new UpdateEventItemBatch();
