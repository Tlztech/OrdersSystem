...
public class A15030103Action extends BaseAction {
	...
	protected void exec() throws Exception {
		...
		try {
			...
			sql = "INSERT INTO fenleiinfo (kanribango,fenlei_name,kubun,comment,area,CREATE_TIME,CREATE_USER,UPDATE_TIME,UPDATE_USER)VALUES(?,?,?,?,?,?,?,?,?);";
			ps = conn.prepareStatement(sql);
			int i = 0;
			ps.setString(++i, Utility.getShoribango());
			ps.setString(++i, f150301.getFenleiName());
			ps.setString(++i, f150301.getType2());
			ps.setString(++i, f150301.getBiko2());
			ps.setString(++i, f150301.getArea2());
