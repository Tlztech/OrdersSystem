...
<%--                 <td>检索结果：<s:label name="f120101.resultCount" />件</td> --%>
        ...
        <table width="960px" class="table" cellspacing="1" cellpadding="1" align="left" border="0">
			<tr class="bg_tr">
				<td width="200px" align="center">专辑名称</td>
				<td width="200px" align="center">商品个数</td>
				<td width="450px" align="center">完成状态</td>
			</tr>
		</table>
		</div>
		<div id="div3">
	    <table width="960px" class="table" cellspacing="1" cellpadding="1" align="left" border="0">
		    <s:iterator value="f120101.albumList" status="status1">
			<tr class="bg_tr">
			    <td width="200px" class="td_bg" align="center"><a target="_blank" href="A12020101?shumokuid=<s:property value='shumokuId'/>"><s:property value='name'/></a><s:hidden name="f120101.albumList[%{#status1.index}].name" value="%{name}"/></td>
				<td width="200px" class="td_bg" align="center"><s:property value='kosu'/><s:hidden name="f120101.albumList[%{#status1.index}].kosu" value="%{kosu}"/></td>
				<td width="450px" class="td_bg" align="center"><s:property value='status'/><s:hidden name="f120101.albumList[%{#status1.index}].status" value="%{status}"/></td>
			</tr>
		    </s:iterator>
		</table>
		</div>
        ...
        <div id='pop-div' style="width:200px;height:250px;display:none;position: fixed;" class="pop-box">   
            ...
            名称&nbsp;<s:textfield name="f120101.addName"/>
            </div>
            <table align="center" width="95%">
                <tr>
                    <td width="25%" align="right"><input type="button" onclick="actionSubmit('A12010102');" value="確定" /></td>
                    <td width="25%"></td>
                    <td width="25%"></td>
