	    ...
	    <table width="560px" class="table" cellspacing="1" cellpadding="1" align="left" border="0">
			...
			<tr class="bg_tr">
				...
				<td width="190px" class="td_bg" align="center">
				    ...
				    <s:hidden name="p010101.categoryList[%{#status.index}].sozaiChn" value="%{sozaiChn}"/>
				    <s:hidden name="p010101.categoryList[%{#status.index}].sozaiJpn" value="%{sozaiJpn}"/>
				    <s:hidden name="p010101.categoryList[%{#status.index}].nameJpn" value="%{nameJpn}"/>
				    <s:hidden name="p010101.categoryList[%{#status.index}].kakaku" value="%{kakaku}"/>
				</td>
			</tr>
		    </s:iterator>
		</table>
