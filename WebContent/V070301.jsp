...
function init() {
   ...
   if (imgs) {
       for ( var i = 0; i < imgs.length; i++) {
           document.getElementsByName("detailImg")[i].src = document.getElementsByName("f070301.nyukaList["+i+"].picUrl")[0].value;
       }
   }
    
    for ( var i = 0; typeof (document
            .getElementsByName("f070301.nyukaList[" + i
...
function checkAll(){
    for ( var i = 0; typeof (document
            .getElementsByName("f070301.nyukaList[" + i
                    + "].checkFlg")[0]) != "undefined"; i++) {
        if (!document.getElementsByName("f070301.nyukaList[" + i
                + "].checkFlg")[0].disabled){
        document.getElementsByName("f070301.nyukaList[" + i
	...
	function print() {
		...
		var commid = document.getElementsByName("f070301.nyukaList[" + index
				+ "].commodityId")[0].value;
		var suryo = document.getElementsByName("f070301.nyukaList[" + index
				+ "].getsu")[0].value;
		var shubeId = document.getElementsByName("f070301.nyukaList[" + index
                + "].shubetuId")[0].value;
		if (suryo == 0) {
			hideDiv();
			alert("数量不能为0");
	...
	function isSuccessPrint(result) {
		...
		if (result != "true") {
			...
			var index = document.form1.rowIndex.value;
			document.getElementsByName("f070301.nyukaList[" + index + "].printStatus")[0].value = "1";	
			setDisplay();
		}
	}
	...
	function isSuccessGet(result) {
        ...
        if (result != "true") {
        	...
        	var index = document.form1.rowIndex.value;
            document.getElementsByName("f070301.nyukaList[" + index + "].commodityStatus")[0].value = "1";  
	...
	function isSuccessGetAll(result) {
        ...
        if (result != "true") {
        	...
        	for ( var i = 0; i < listLength; i++) {
                if (document.getElementsByName("f070301.nyukaList[" + i
                        + "].checkFlg")[0].checked == true) {
                	 document.getElementsByName("f070301.nyukaList[" + i + "].commodityStatus")[0].value = "1";  
                	 document.getElementsByName("f070301.nyukaList[" + i
                             + "].checkFlg")[0].checked = false;
                }
                //if(document.getElementsByName("printFlg")[0].checked){
               //     document.getElementsByName("f070301.nyukaList[" + i + "].printStatus")[0].value = "1";
              //  }
            };
            setDisplay();
            alert("操作成功");
	...
	function isSuccessProblem(result) {
        ...
        if (result != "true") {
        	...
        	var index = document.form1.rowIndex.value;
            alert("操作成功");
            document.getElementsByName("f070301.nyukaList[" + index + "].commodityStatus")[0].value = "2";
            setDisplay();
        }
    }
	...
	function isSuccessOk(result) {
        ...
        if (result != "true") {
        	...
        	var index = document.form1.rowIndex.value;
            alert("操作成功");
            document.getElementsByName("f070301.nyukaList[" + index + "].commodityStatus")[0].value = "3";
            setDisplay();
        }
    }
	...
	function setDisplay(){
		...
		for ( var i = 0; i < listLength; i++) {
            if (document.getElementsByName("f070301.nyukaList[" + i
                 ...
                 document.getElementsByName("f070301.nyukaList[" + i + "].getsu")[0].readOnly = false;
                 document.getElementsByName("f070301.nyukaList[" + i + "].getsu")[0].className = "";
                 
            }else if (document.getElementsByName("f070301.nyukaList[" + i
                ...
                document.getElementsByName("f070301.nyukaList[" + i + "].getsu")[0].readOnly = true;
                document.getElementsByName("f070301.nyukaList[" + i + "].getsu")[0].className = "readonly";
                ...
                document.getElementsByName("f070301.nyukaList["+i+"].checkFlg")[0].disabled = true;
            }
	...
	function setProblem(){
	      var index = document.form1.rowIndex.value;
	        ...
	        var shubeId = document.getElementsByName("f070301.nyukaList[" + index
	                + "].shubetuId")[0].value;
	        var remarks = document.getElementsByName("f070301.nyukaList[" + index
	                + "].remarks")[0].value;
	...
	function getChecked(){
        ...
        for ( var i = 0; i < listLength; i++) {
            if (document.getElementsByName("f070301.nyukaList[" + i
                ...
                var commid = document.getElementsByName("f070301.nyukaList[" + index
                        + "].commodityId")[0].value;
                var jinhuosu = document.getElementsByName("f070301.nyukaList[" + index
                        + "].nyukasu")[0].value;
                var suryo = document.getElementsByName("f070301.nyukaList[" + index
                        + "].getsu")[0].value;
                var shubeId = document.getElementsByName("f070301.nyukaList[" + index
                ...
                var remarks = document.getElementsByName("f070301.nyukaList[" + index
                        + "].remarks")[0].value;
                var a_date = document.getElementsByName("f070301.nyukaList[" + index
                        + "].nyukabi")[0].value;
                if(remarks == ""){
                	remarks = " ";
                }
		...
		<table cellspacing="1" cellpadding="2" width="90%" border="0">
            <tr class="bg_tr">
                ...
                <td class="td_bg" width="210px">
                    <s:textfield size="20" maxlength="20" name="f070301.commodityId"/>
                </td>
                <td class="td_bg" width="80px">进货日期：</td>
                <td class="td_bg">
                    <s:textfield size="15" cssClass="Wdate" onClick="WdatePicker()" maxlength="8" name="f070301.nyukabiStart" /> ～
                    <s:textfield size="15" cssClass="Wdate" onClick="WdatePicker()" maxlength="8" name="f070301.nyukabiEnd" />
                </td>
            </tr>
<!--             <tr class="bg_tr"> -->
<!--                 <td class="td_bg" width="80px">中文名：</td> -->
<!--                 <td class="td_bg" width="210px" colspan="3"> -->
<%--                     <s:textfield size="20" maxlength="40" name="f070301.chineseName"/> --%>
<!--                 </td> -->
<!--             </tr> -->
            <tr class="bg_tr">
                <td class="td_bg" width="80px">签收状态：</td>
                <td class="td_bg" width="210px">
                    <s:select list="#{ '3':'未签收', '2':'已签收'}"   name="f070301.commodityStatus"/>
                </td>
<!--                 <td class="td_bg" width="80px">打印状态：</td> -->
<!--                 <td class="td_bg"> -->
<%--                     <s:select list="#{ '1':'全部', '2':'已打印','3':'未打印'}"   name="f070301.printStatus"/> --%>
<!--                 </td> -->
<!--             </tr> -->
...
<!--                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" onclick="actionSubmit('A10010107');" value="下载进货单"/></td> -->
                <td align="right"><input type="button" onclick="popupDiv();actionSubmit('A07030102')" value="检索" style="width:50px;height:25px"/></td>
		    </tr>
		</table>
		</div>
		<div id="div2">
		...
		<table width="1000px">
            <tr>
                <td width="600px">检索结果：<s:label name="f070301.resultCount" />件</td>
                <td align="right">
...
<!-- 				<td width="100px" align="center">备注</td> -->
	    ...
	    <table width="1000px" class="table" cellspacing="1" cellpadding="1" align="left" border="0" style="word-break:break-all">
		    <s:iterator value="f070301.nyukaList" status="status">
			<tr class="bg_tr">
			    <td width="40px" class="td_bg" align="center" id="checktd[${status.index}]1"><s:checkbox onclick="checkIt(this.name)" name="f070301.nyukaList[%{#status.index}].checkFlg"/></td>
			    <td width="100px" class="td_bg" align="center" id="checktd[${status.index}]2"><s:property value='nyukabi'/><s:hidden name="f070301.nyukaList[%{#status.index}].nyukabi" value="%{nyukabi}"/>
			    <td width="100px" class="td_bg" align="center" id="checktd[${status.index}]3"><s:if test="commodityId.contains('-S5')"><font color="red"></s:if><s:property value='commodityId'/><s:hidden name="f070301.nyukaList[%{#status.index}].commodityId" value="%{commodityId}"/>
			    <s:hidden name="f070301.nyukaList[%{#status.index}].shubetuId" value="%{shubetuId}"/></td>
			    <td width="100px" class="td_bg" align="center" id="checktd[${status.index}]12"><s:if test="commodityId.contains('-S5')"><font color="red"></s:if><s:property value='describe'/><s:hidden name="f070301.nyukaList[%{#status.index}].describe" value="%{describe}"/>
			    <td width="100px" class="td_bg" align="center" id="checktd[${status.index}]4"><a href="javascript:showImg('<s:property value='picUrl'/>')"><img name="detailImg" width="70px" height="70px"></a><s:hidden name="f070301.nyukaList[%{#status.index}].picUrl" value="%{picUrl}"/></td>
				<td width="180px" style="display:none" class="td_bg" align="center" id="checktd[${status.index}]5"><s:property value='chineseName'/><s:hidden name="f070301.nyukaList[%{#status.index}].chineseName" value="%{chineseName}"/></td>
				<td width="60px" class="td_bg" align="center" id="checktd[${status.index}]6"><s:property value='commodityStatusName'/><s:hidden name="f070301.nyukaList[%{#status.index}].commodityStatusName" value="%{commodityStatusName}"/></td>
				<td width="60px" class="td_bg" align="center" id="checktd[${status.index}]7"><s:property value='printStatusName'/><s:hidden name="f070301.nyukaList[%{#status.index}].printStatusName" value="%{printStatusName}"/></td>
				<td width="60px" class="td_bg" align="center" id="checktd[${status.index}]8"><s:property value='nyukasu'/><s:hidden name="f070301.nyukaList[%{#status.index}].nyukasu" value="%{nyukasu}"/></td>
				<td width="60px" class="td_bg" align="center" id="checktd[${status.index}]9"><s:textfield readOnly="true" cssClass="readonly" size="2" name="f070301.nyukaList[%{#status.index}].getsu" value="%{getsu}"/></td>
				<td width="100px" style="display:none" class="td_bg" align="center" id="checktd[${status.index}]10"><s:textarea style="width:90px;height:40px" name="f070301.nyukaList[%{#status.index}].remarks" value="%{remarks}"/></td>
				<td class="td_bg" align="center" id="checktd[${status.index}]11">
				    <s:hidden name="f070301.nyukaList[%{#status.index}].commodityStatus" value="%{commodityStatus}"/>
				    <s:hidden name="f070301.nyukaList[%{#status.index}].printStatus" value="%{printStatus}"/>
...
<%-- 				    <input type="button" style="display:none" name="button2" style="width:70px" onclick="popupDiv();document.form1.rowIndex.value=${status.index};updateCommodity();" value="更　新"/>&nbsp;&nbsp;&nbsp; --%>
<%-- 				    <input type="button" style="display:none" name="button3" style="width:70px" onclick="popupDiv();document.form1.rowIndex.value=${status.index};print();" value="打印标签"/>&nbsp;&nbsp;&nbsp;<br> --%>
...
<!-- 		    <tr> -->
<!-- 		        <td> -->
<!-- 		            <a href="#" id="firstPage" onclick="actionSubmit('A07030108?page=first')">首页</a>&nbsp;<a href="#" id="lastPage" onclick="actionSubmit('A07030108?page=last')">上一页</a>&nbsp; -->
<!-- 		            <a href="#" id="nextPage" onclick="actionSubmit('A07030108?page=next')">下一页</a>&nbsp;<a href="#" id="endPage" onclick="actionSubmit('A07030108?page=end')">尾页</a> -->
<%-- 		            &nbsp;&nbsp;&nbsp;&nbsp;第<s:label name="nowPage"/><s:hidden id="nowPage" name="nowPage"/>页&nbsp;/&nbsp;共<s:label name="allPage"/><s:hidden id="allPage" name="allPage"/>页 --%>
<%-- 		            &nbsp;&nbsp;&nbsp;&nbsp;跳转到<s:textfield cssErrorStyle="background:red;" name="goPage" size="1"/>页 <input onclick="actionSubmit('A07030108?page=go')" type="button" value="GO"> --%>
<!-- 		        </td> -->
<!-- 		    </tr> -->
<!-- 		</table> -->
<!-- 		</div> -->
		<s:hidden name="viewId" value="V070301"/>
