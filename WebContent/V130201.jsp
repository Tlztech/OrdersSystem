...
<div id='mask' class="mask" style="width:100%;height:100%;display:none"></div>
    <s:form name="form1" theme="simple" enctype="multipart/form-data">
        ...
        <table cellspacing="1" cellpadding="2" width="1150px" border="0" class="table">
            <tr class="bg_tr">
                <s:if test="f130201.tenposhubetsu == 1"><td width="100px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="100px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13020104?type=1')">楽天(<s:text name="f130201.rakutenCount"/>)<s:hidden name="f130201.rakutenCount"/></a></td>
                <s:if test="f130201.tenposhubetsu == 2"><td width="200px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="200px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13020104?type=2')">Yahooショッピング(<s:text name="f130201.yahooShoppingCount"/>)<s:hidden name="f130201.yahooShoppingCount"/></a></td>
                <s:if test="f130201.tenposhubetsu == 3"><td width="100px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="100px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13020104?type=3')">DENA(<s:text name="f130201.denaCount"/>)</a><s:hidden name="f130201.denaCount"/></td>
                <s:if test="f130201.tenposhubetsu == 4"><td width="100px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="100px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13020104?type=4')">ヤフオク(<s:text name="f130201.yafuokuCount"/>)</a><s:hidden name="f130201.yafuokuCount"/></td>
                ...
                <s:if test="f130201.tenposhubetsu == 7"><td width="100px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="100px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13020104?type=7')">AU(<s:text name="f130201.auCount"/>)</a><s:hidden name="f130201.auCount"/></td>
                <s:if test="f130201.tenposhubetsu == 8"><td width="100px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="100px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13020104?type=8')">その他(<s:text name="f130201.otherCount"/>)</a><s:hidden name="f130201.otherCount"/></td>
