    ...
    <s:form name="form1" theme="simple" enctype="multipart/form-data">
        ...
        <table cellspacing="1" cellpadding="2" width="1150px" border="0" class="table">
            <tr class="bg_tr">
                ...
                <s:if test="f130201.tenposhubetsu == 5"><td width="200px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="200px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13020104?type=5')">ポンパレモール(<s:text name="f130201.ponpareCount"/>)</a><s:hidden name="f130201.ponpareCount"/></td>
                ...
                <s:if test="f130201.tenposhubetsu == 7"><td width="150px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="150px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13020104?type=7')">その他(<s:text name="f130201.otherCount"/>)</a><s:hidden name="f130201.otherCount"/></td>
