...
function setInfoVal(infoVal){
	...
	// 是快递单号
	if((infoVal.charAt(0) == 3 || infoVal.charAt(0) == 4 || infoVal.charAt(0) == 1 || infoVal.charAt(0) == 5) && infoVal.length == 12){
...
<!--             </tr> -->
        ...
        <table cellspacing="1" cellpadding="2" width="1150px" border="0" class="table">
            <tr class="bg_tr">
                <s:if test="f130101.tenposhubetsu == 1"><td width="150px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="150px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13010105?type=1')">楽天(<s:text name="f130101.rakutenCount"/>)<s:hidden name="f130101.rakutenCount"/></a></td>
                ...
                <s:if test="f130101.tenposhubetsu == 3"><td width="150px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="150px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13010105?type=3')">DENA(<s:text name="f130101.denaCount"/>)</a><s:hidden name="f130101.denaCount"/></td>
                <s:if test="f130101.tenposhubetsu == 4"><td width="150px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="150px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13010105?type=4')">ヤフオク(<s:text name="f130101.yafuokuCount"/>)</a><s:hidden name="f130101.yafuokuCount"/></td>
                <s:if test="f130101.tenposhubetsu == 5"><td width="200px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="200px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13010105?type=5')">ポンパレモール(<s:text name="f130101.ponpareCount"/>)</a><s:hidden name="f130101.ponpareCount"/></td>
                <s:if test="f130101.tenposhubetsu == 6"><td width="150px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="150px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13010105?type=6')">qoo10(<s:text name="f130101.qoo10Count"/>)</a><s:hidden name="f130101.qoo10Count"/></td>
                <s:if test="f130101.tenposhubetsu == 7"><td width="150px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="150px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13010105?type=7')">その他(<s:text name="f130101.otherCount"/>)</a><s:hidden name="f130101.otherCount"/></td>
