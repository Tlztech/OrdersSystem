...
<!--             </tr> -->
        ...
        <table cellspacing="1" cellpadding="2" width="600px" border="0" class="table">
            <tr class="bg_tr">
                ...
                <s:if test="f130101.tenposhubetsu == 2"><td width="150px" class="td_bg" style="font-size:13px;background-color: lightblue" align="center"></s:if><s:else><td width="150px" class="td_bg" style="font-size:13px" align="center"></s:else><a href="javascript:actionSubmit('A13010105?type=2')">Yahooショッピング(<s:text name="f130101.yahooShoppingCount"/>)<s:hidden name="f130101.yahooShoppingCount"/></a></td>
